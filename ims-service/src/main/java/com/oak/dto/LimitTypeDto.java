...
public class LimitTypeDto extends AuditableDto implements Identifiable {
	@IsNull(groups = CreateValidationGroup.class, value = "Limit Type Id")
    @IsNotNull(groups = UpdateValidationGroup.class, value = "Limit Type Id")
	private Long id;
