...
public class MeasurementLocationDto extends AuditableDto implements Identifiable {
	@IsNull(groups = CreateValidationGroup.class, value = "Measurement Location Id")
    @IsNotNull(groups = UpdateValidationGroup.class, value = "Measurement Location Id")
	private Long id;
