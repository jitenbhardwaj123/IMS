...
public class UnitTypeDto extends AuditableDto implements Identifiable {
	@IsNull(groups = CreateValidationGroup.class, value = "Unit Type Id")
    @IsNotNull(groups = UpdateValidationGroup.class, value = "Unit Type Id")
	private Long id;
